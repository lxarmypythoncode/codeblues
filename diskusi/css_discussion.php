...
<body>
    <div class="container">
        ...
        <form id="discussionForm">
            <label for="discussion">Bagikan pendapat Anda tentang CSS:</label>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            animationDiv.style.backgroundColor = "#e6f7ff";
            animationDiv.style.padding = "20px";
            animationDiv.style.borderRadius = "10px";
            animationDiv.style.boxShadow = "0 0 10px rgba(0, 0, 0, 0.1)";
            animationDiv.innerHTML = "<p>CSS adalah tentang gaya! Mari kita buat halaman web kita menjadi indah.</p>";
