...
<body>
    <div class="container">
        <h1>Diskusi Tim Biru</h1>
        <div id="discussion_animation"></div>
        <form id="discussionForm">
            <label for="discussion">Bagikan pendapat Anda tentang kegiatan Tim Biru:</label>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            animationDiv.style.backgroundColor = "#bee5eb";
            animationDiv.style.padding = "20px";
            animationDiv.style.borderRadius = "10px";
            animationDiv.style.boxShadow = "0 0 10px rgba(0, 0, 0, 0.1)";
            animationDiv.innerHTML = "<p>Tim Biru fokus pada strategi defensif. Mari diskusikan metode perlindungan!</p>";
        ...
        function saveDiscussion(discussionText) {
            let discussions = JSON.parse(localStorage.getItem('discussions_blue_team')) || [];
            discussions.push({ text: discussionText, replies: [] });
            localStorage.setItem('discussions_blue_team', JSON.stringify(discussions));
        }
